window.DATA = {
  ru: {
    ...
    nav: [
      { label: "О проекте", href: "#about-product" },
      { label: "Как это работает", href: "#steps" },
      { label: "Автор", href: "#author" },
      { label: "Доступ", href: "#pricing" },
      { label: "FAQ", href: "#faq" },
    ],
    hero: {
      eyebrow: "AI-гид для фотосессии",
      ...
      noteText: "Она начинается с ясного понимания себя, своего вайба и визуального языка.",
    },
    intro: [
      {
        eyebrow: "Для кого",
    ...
    steps: {
      ...
      text:
        "Никаких таблиц и скучных шаблонов. Только короткий путь от «я не понимаю, какой образ выбрать» к ясной съёмочной концепции.",
      items: [
        {
          number: "01",
    ...
    story: {
      ...
      bullets: [
        ...
        "Подходит и для личного бренда, и для съёмки для себя",
      ],
    },
    system: {
      eyebrow: "Что внутри",
      title: "Система, а не вдохновение на один вечер",
      text:
        "Ты получаешь не набор красивых картинок, а структуру: какие фото выбирать, что надевать, как держаться в кадре и какой вайб собирать целиком.",
    },
    author: {
      eyebrow: "Об авторе",
      title: "Привет, я Надя",
    ...
    pricing: {
      ...
      currency: "₽",
      features: [
        "AI-разбор твоей внешности и стилистики",
        "Подбор образов, поз и света",
    ...
    faq: {
      ...
      title: "Чтобы не сомневаться до оплаты",
      items: [
        {
          q: "Как я получу доступ после оплаты?",
          a: "Сразу после оплаты открывается страница с материалами и инструкцией по старту.",
        },
        {
          q: "Сколько времени занимает прохождение?",
          a: "Первый понятный результат можно собрать за один вечер, без сложного онбординга и длинного обучения.",
        },
        {
          q: "Подойдёт ли это для личного бренда?",
          a: "Да. Методика полезна для экспертов, творческих проектов, контент-съёмок и фотосессий для себя.",
        },
        {
          q: "Что если я не умею позировать?",
          a: "Именно для этого внутри есть рекомендации по подаче, настроению кадра и тому, как чувствовать себя в съёмке увереннее.",
        },
      ],
    },
    cta: {
    ...
    footer: {
      description:
        "Инструмент для тех, кто хочет подготовить фотосессию вокруг собственной визуальной идентичности, а не вокруг случайных референсов.",
      columns: [
        {
          title: "Разделы",
          links: [
        ...
        },
        {
          ...
          links: [
            ...
            { label: "FAQ", href: "#faq" },
            { label: "Получить доступ", href: "#cta" },
          ],
        },
        {
          title: "Контакты",
          links: [
            { label: "hello@styleself.ru", href: "mailto:hello@styleself.ru" },
            { label: "Telegram", href: "#" },
          ],
        },
      ],
  ...
  en: {
    ...
    nav: [
      { label: "About", href: "#about-product" },
    ...
    hero: {
      eyebrow: "AI guide for your photoshoot",
      ...
      noteText: "It starts with a clear understanding of yourself, your vibe, and your visual language.",
    },
    intro: [
      {
    ...
    steps: {
      ...
      title: "Three steps to a photoshoot that actually sounds like you",
      text:
        "No spreadsheets and no stiff templates. Just a short route from 'I do not know what image to choose' to a clear visual direction.",
      items: [
        {
          number: "01",
    ...
    story: {
      ...
      bullets: [
        ...
        "Works for personal branding and for shoots just for yourself",
      ],
    },
    system: {
      eyebrow: "What is inside",
      title: "A system, not one night of inspiration",
      text:
        "You get more than pretty images. You get structure: which photos to choose, what to wear, how to carry yourself on camera, and what overall vibe to build.",
    },
    author: {
    ...
    pricing: {
      ...
      currency: "₽",
      features: [
        "AI analysis of your features and personal style",
        "Outfit, pose, and lighting recommendations",
    ...
    faq: {
      eyebrow: "FAQ",
      title: "So you do not hesitate before paying",
      items: [
        {
          q: "How do I get access after payment?",
          a: "Right after payment you receive access to the materials and a simple instruction on where to start.",
        },
        {
          q: "How long does it take to go through?",
          a: "You can get your first clear result in one evening, without a heavy onboarding process or long training.",
        },
        {
          q: "Does it work for personal branding?",
          a: "Yes. The method is useful for experts, creative work, content shoots, and sessions just for yourself.",
        },
        {
          q: "What if I do not know how to pose?",
          a: "That is exactly why the material includes guidance on presence, mood, and how to feel more confident during the shoot.",
        },
      ],
    },
    cta: {
    ...
    footer: {
      description:
        "A tool for people who want to prepare a photoshoot around their own visual identity instead of around random saved references.",
      columns: [
        {
          title: "Sections",
          links: [
